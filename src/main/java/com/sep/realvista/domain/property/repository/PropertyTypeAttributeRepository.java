...
public interface PropertyTypeAttributeRepository extends JpaRepository<PropertyTypeAttribute, UUID> {
    ...
    @Query("""
       SELECT pta
       FROM PropertyTypeAttribute pta
       ...
       ORDER BY pa.name
       """)
    List<PropertyTypeAttribute> findSearchableAttributesByPropertyTypeCode(
    ...
    @Query("""
       ...
       ORDER BY pa.name
       """)
    List<PropertyTypeAttribute> findSearchableAttributesByPropertyCategoryCode(
