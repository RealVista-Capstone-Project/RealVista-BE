...
public class PropertyAttributeController {
    ...
    @Operation(summary = "Get Searchable Attributes by Property Type", 
               description = "Returns all searchable attributes for a specific property type (e.g., APARTMENT, VILLA)")
    ...
    @Operation(summary = "Get Searchable Attributes by Property Category",
               description = "Returns all searchable attributes for a property category (e.g., RESIDENTIAL, COMMERCIAL)")
