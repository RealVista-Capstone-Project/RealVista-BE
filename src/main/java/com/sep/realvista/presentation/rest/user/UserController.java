...
public class UserController {
    ...
    @Operation(summary = "Get paginated users",
            description = "Retrieves a paginated list of users with search and filters (Admin only)")
    public ResponseEntity<ApiResponse<Page<UserResponse>>> getPagedUsers(
        ...
        log.info("Fetching paginated users - traceId: {}, filter: {}", traceId, filter);

        Page<UserResponse> users = userApplicationService.getPagedUsers(filter, pageable);
