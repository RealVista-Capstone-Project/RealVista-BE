 ...
 * <p>
 * All values are sourced from environment variables via the {@code docusign.*}
 * prefix.
 * The application functions without DocuSign (graceful degradation) if
 * credentials
...
public class DocuSignConfig {
  ...
  /**
   * Frontend base URL used to build the post-signing redirect.
   * The full redirect is:
   * {@code {returnUrl}/{locale}/leases/signing-complete?leaseId=...&amp;role=...}
   * Set via DOCUSIGN_RETURN_URL env var (e.g. {@code https://yourdomain.com}).
   */
