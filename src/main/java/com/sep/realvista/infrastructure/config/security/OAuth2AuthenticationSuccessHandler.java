    ...
    public void onAuthenticationSuccess(HttpServletRequest request, 
        ...
        try {
            ...
            if (email == null) {
                ...
                response.sendRedirect(SecurityConstants.Url.FRONTEND_URL + "/login?error=no_email");
                return;
            }
            ...
            String redirectUrl = String.format("%s/auth/callback?token=%s&userId=%d&email=%s",
                SecurityConstants.Url.FRONTEND_URL, jwtToken, user.getId(), email);
            ...
            response.sendRedirect(SecurityConstants.Url.FRONTEND_URL + "/login?error=auth_failed");
        }
    }
