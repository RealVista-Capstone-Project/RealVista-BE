-- Fix banner image rendering in price-change emails:
--   * Escape `&` as `&amp;` so strict HTML parsers (Outlook) keep the URL intact.
--   * Use a colored gradient hero block as the *visual* banner (always renders, no
--     image proxy / CORS / blocked-image issues), with the listing photo overlaid
--     at a safe size when the email client decides to load it.
--   * Provide a CSS background-color fallback so the banner is never empty.
  ...
  <tr>
    <td align="center">
      <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:600px;background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 10px 40px rgba(2,132,199,0.15);">
        <!-- HERO BANNER (gradient + brand text — always renders, no external image) -->
        <tr>
          <td style="background:#0284C7;background-image:linear-gradient(135deg,#0EA5E9 0%,#0284C7 50%,#0369A1 100%);padding:0;">
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
              <tr>
                <td align="center" style="padding:42px 24px 14px;">
              ...
              <tr>
                <td style="padding:0;">
                  <img src="https://images.unsplash.com/photo-1564013799919-ab600027ffc6?w=600&amp;h=200&amp;fit=crop&amp;q=70"
                       alt=""
                       width="600" height="200"
                       style="display:block;width:100%;max-width:600px;height:200px;border:0;outline:0;object-fit:cover;"/>
                </td>
              </tr>
            </table>
          </td>
        ...
        <tr>
          <td style="background:#0284C7;background-image:linear-gradient(135deg,#0EA5E9 0%,#0284C7 50%,#0369A1 100%);padding:0;">
            <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td style="padding:0;">
                  <img src="https://images.unsplash.com/photo-1572120360610-d971b9d7767c?w=600&amp;h=200&amp;fit=crop&amp;q=70"
                       alt=""
                       width="600" height="200"
                       style="display:block;width:100%;max-width:600px;height:200px;border:0;outline:0;object-fit:cover;"/>
                </td>
