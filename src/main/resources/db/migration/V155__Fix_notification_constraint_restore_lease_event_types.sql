-- Fix: V153 accidentally dropped LEASE_SIGNED, LEASE_LANDLORD_SIGNED, and LEASE_EXPIRY_REMINDER
-- from the chk_notification_event_type constraint when adding appointment reschedule types.
-- This migration restores the full list.
